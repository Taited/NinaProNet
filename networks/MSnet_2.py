...
class MSnet_2(Module):
    '''
    第2版本的MultiSpacingNetwork，low/middle/high pixel feature map 均经上下采样后concat，
    low pixel net 用single separate conv代替3dconv。
    '''
    def __init__(self,  inc=1, n_classes=5, base_chns=16, droprate=0, norm='in', depth=False, dilation=1):
        super(MSnet_2, self).__init__()
        self.model_name = "seg"
        ...
        self.conv1_1_lr = SingleSeparateConv3D(inc, base_chns, norm=norm, depth=depth, dilat=dilation, pad='same')
        self.conv1_2_lr = SingleSeparateConv3D(base_chns, 2*base_chns, norm=norm, depth=depth, dilat=dilation, pad='same')
        ...
        self.conv2_1_lr = SingleSeparateConv3D(2*base_chns, 2*base_chns, norm=norm, depth=depth, dilat=dilation, pad='same')
        self.conv2_2_lr = SingleSeparateConv3D(2 * base_chns, 4 * base_chns, norm=norm, depth=depth, dilat=dilation, pad='same')
        ...
        self.conv3_1_lr = SingleSeparateConv3D(4*base_chns, 4*base_chns, norm=norm, depth=depth, dilat=dilation, pad='same')
        self.conv3_2_lr = SingleSeparateConv3D(4 * base_chns, 4 * base_chns, norm=norm, depth=depth, dilat=dilation, pad='same')
        ...
        self.conv4_1_lr = SingleSeparateConv3D(4*base_chns, 8*base_chns, norm=norm, depth=depth, dilat=math.ceil(dilation/2), pad='same')
        self.conv4_2_lr = SingleSeparateConv3D(8 * base_chns, 8 * base_chns, norm=norm, depth=depth, dilat=math.ceil(dilation/2), pad='same')
        ...
        self.conv5_1_lr = SingleSeparateConv3D(12*base_chns, 8*base_chns, norm=norm, depth=depth, dilat=dilation, pad='same')
        self.conv5_2_lr = SingleSeparateConv3D(8 * base_chns, 8 * base_chns, norm=norm, depth=depth, dilat=dilation, pad='same')
        ...
        self.conv6_1_lr = SingleSeparateConv3D(12*base_chns, 4*base_chns, norm=norm, depth=depth, dilat=dilation, pad='same')
        self.conv6_2_lr = SingleSeparateConv3D(4 * base_chns, 4 * base_chns, norm=norm, depth=depth, dilat=dilation, pad='same')
        ...
        self.conv7_1_lr = SingleSeparateConv3D(6*base_chns, 2*base_chns, norm=norm, depth=depth, dilat=dilation, pad='same')
        self.conv7_2_lr = SingleSeparateConv3D(2 * base_chns, 2 * base_chns, norm=norm, depth=depth, dilat=dilation, pad='same')
