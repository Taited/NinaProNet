...
class RUnet_Separate_5(Module):
    def __init__(self,  inc=1, n_classes=5, base_chns=16, droprate=0, norm='in', depth=False, dilation=1, outfeature=False):
        super(RUnet_Separate_5, self).__init__()
        self.model_name = "seg"
        ...
        self.conv1_1 = SingleResSeparateConv3D(inc, base_chns, norm=norm, depth=depth, dilat=dilation, pad='same')
        ...
        self.conv4_1 = SingleResSeparateConv3D(8*base_chns, 8*base_chns, norm=norm, depth=depth, dilat=math.ceil(dilation/2), pad='same')
        self.conv4_2 = SingleResSeparateConv3D(8 * base_chns, 16 * base_chns, norm=norm, depth=depth, dilat=math.ceil(dilation/2), pad='same')

        self.conv5_1 = SingleResSeparateConv3D(24*base_chns, 8*base_chns, norm=norm, depth=depth, dilat=dilation, pad='same')
        ...
        self.conv7_1 = SingleResSeparateConv3D(6*base_chns, 2*base_chns, norm=norm, depth=depth, dilat=dilation, pad='same')
