...
# adapt_thresh from https://github.com/Kamnitsask/deepmedic
...
class DeepMedic(nn.Module):
    def __init__(self, inc=4, n1=30, n2=40, n3=50, m=150, up=True, n_classes=5, base_chns=12, droprate=0, norm='in', depth = False, dilation=1):
