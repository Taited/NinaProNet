...
class rf_net4(nn.Module):
    ...
    def __init__(self, channel, num_classes, se=True, reduction=2, norm='bn'):
        ...
        self.up2 = up_block(in_ch=48, out_ch=32, kernel=(3, 4, 4), scale=(
    ...
    def forward(self, x, branch='G'):
        # main branch
        if branch == 'G':
            return self.forwardG(x)
        else:
    ...
    def forwardG(self, x):
        ...
        out = self.up2(out, self.literal2(o1))
